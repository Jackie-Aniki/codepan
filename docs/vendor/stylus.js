...
var stylus = (function () {
    ...
    function (module, exports, require) {
      ...
      module.exports = function contrast(top, bottom) {
        ...
        if (1 <= bottom.a) {
          ...
          var onBlack = contrast(
              top,
              blend(bottom, new nodes.RGBA(0, 0, 0, 1))
            ),
            onWhite = contrast(
              top,
          ...
          result.set(
            'ratio',
            new nodes.Unit(Math.round((min + max) * 50) / 100)
          )
          result.set(
            'error',
            new nodes.Unit(Math.round((max - min) * 50) / 100)
          )
  ...
  require.register(
    'functions/opposite-position.js',
    function (module, exports, require) {
      var utils = require('../utils'),
        nodes = require('../nodes')
  ...
  require.register('lexer.js', function (module, exports, require) {
    ...
    Lexer.prototype = {
      ...
      namedop: function () {
        ...
        if (
          (captures =
            /^(not|and|or|is a|is defined|isnt|is not|is)(?!-)\b([ \t]*)/.exec(
              this.str
            ))
        ) {
          var op = captures[1]
    ...
    String.prototype.operate = function (op, right) {
      switch (op) {
        case '%':
          ...
          expr.push(this)
          var args =
            'expression' == right.nodeName ? utils.unwrap(right).nodes : [right]
