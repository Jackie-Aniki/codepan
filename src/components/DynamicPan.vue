<template>
  <html-pan v-if="pan === 'html'" class="pan" />
  <css-pan v-else-if="pan === 'css'" class="pan" />
  <js-pan v-else-if="pan === 'js'" class="pan" />
  <console-pan v-else-if="pan === 'console'" class="pan" />
  <output-pan v-else-if="pan === 'output'" class="pan" />
</template>
